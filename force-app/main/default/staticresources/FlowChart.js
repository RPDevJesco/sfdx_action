const generateFlowChart = {
    init(container,paletteContainer,$, go, saveButton, saveDataModel) {
        myDiagram =
            new go.Diagram(container,  // must name or refer to the DIV HTML element
                {
        ...
        this.load(saveDataModel, myDiagram, go);
        // initialize the Palette that is on the left side of the page
        Palette =
        new go.Palette(paletteContainer,  // must name or refer to the DIV HTML element
            {
                // simplify the drag-and-drop from the Palette
                mouseDragOver: function(e) { e.diagram.currentCursor = ""; },
